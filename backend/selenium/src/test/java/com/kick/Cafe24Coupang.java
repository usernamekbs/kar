...
//        	reRealPrice = Integer.toString(reInPrice); 
	    	...
	    	List<CoupangAttributes> attri = new ArrayList<>();
	    	Map<Long,CoupangAttributes> map = new HashMap<>();
        	//셀렉트
	        	...
	        	for(WebElement option : optionList) {
	        		if(sel.getAttribute("id").equals("product_option_id1")) {
	        			...
	        			if(option.isEnabled()) {
	        				...
	        				map.put(coupangAttributes.getId(), coupangAttributes);
	        				
	        				attri.add(coupangAttributes);
