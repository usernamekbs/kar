...
class Cafe24DesignBani {
	...
	void asd() throws InterruptedException, IOException {
	    ...
	    driver.get("https://designbani.com/member/login.html");
        WebElement member_id=driver.findElement(By.id("member_id"));
        WebElement member_passwd=driver.findElement(By.id("member_passwd"));
        WebElement login=driver.findElement(By.cssSelector("form > div > div > fieldset > div > a"));
        ...
        //19까지 함 APPLE
        driver.navigate().to("https://designbani.com/product/search.html?banner_action=&view_type=&supplier_code=&search_type=product_name&keyword=%ED%8F%B4%EB%93%9C");
...
//        WebElement totalCount=driver.findElement(By.cssSelector("#contents > div.xans-element-.xans-product.xans-product-normalpackage > div.xans-element-.xans-product.xans-product-normalmenu > div > p > strong"));
        //tcnt
        for(int i=1; i<=5;i++) {
        	WebElement nextPage=driver.findElement(By.cssSelector("#contents_sub > div.guide_contents > div.xans-element-.xans-search.xans-search-paging.ec-base-paginate > a:nth-child(4) > img"));
        	
        	List<WebElement> elements = driver.findElements(By.cssSelector("#contents_sub > div.guide_contents > div.xans-element-.xans-search.xans-search-result.ec-base-product > ul > li> div.thumbnail > div.prdImg > a"));
        ...
        for(String url : urls) {
        	...
        	WebElement cl = driver.findElement(By.cssSelector("#prdDetail > li.tap_sele > a"));
        	cl.click();
        	Thread.sleep(3000);
        	JavascriptExecutor js = (JavascriptExecutor) driver;
        	//셀렉트박스는 두개값 만 가져옴
        	List<WebElement> selectLists = driver.findElements(By.cssSelector("#mvarea > div > div.xans-element-.xans-product.xans-product-option.xans-record- > table > tbody.xans-element-.xans-product.xans-product-option.xans-record- > tr >td >select"));
        	...
        	List<WebElement> thumbLists = driver.findElements(By.cssSelector("#contents > div.detaarea > div.bg_gray > div > div.xans-element-.xans-product.xans-product-detail > div.detailArea > div.imgArea > div.xans-element-.xans-product.xans-product-image > div.keyImg > div > a > img"));
        	List<WebElement> detailImageLists = driver.findElements(By.cssSelector("#contents > div.detaarea > div.xans-element-.xans-product.xans-product-additional > div.cont.guide_contents > div > center > div.continner > p > img"));
            List<WebElement> detailImageLists2 = driver.findElements(By.cssSelector("#contents > div.detaarea > div.xans-element-.xans-product.xans-product-additional > div.cont.guide_contents > div > center > div.continner > img"));
            List<WebElement> detailImageLists3 = driver.findElements(By.cssSelector("#contents > div.detaarea > div.xans-element-.xans-product.xans-product-additional > div.cont.guide_contents > div > center > div.continner > div > p > img	"));
...
//            	 Thread.sleep(3000);
		   		 System.out.println("1111111111111111111111"+imgUrl);
...
//            	 Thread.sleep(3000);
        		 ...
        		 String detailImg = "<p align=\"center\">"+"<img src='https://qudtn0295.cafe24.com/detailImage11/"+URLDecoder.decode(detailName,"UTF-8").toString().substring(0, URLDecoder.decode(detailName,"UTF-8").length()-4)+".jpeg"+"'/>"+"</p>";
        		 sb.append(detailImg);
        		 imgs.add(imgUrl);
            }
            ...
            StringBuilder sb2 =new StringBuilder();
		   	for(WebElement detailImage2 : detailImageLists2) {
		   		 ...
		   		 System.out.println("22222222222222222222"+imgUrl2);
		   		 ((JavascriptExecutor) driver).executeScript(
...
//		   		 Thread.sleep(3000);
	   			 detailName2 = detailImage2.getAttribute("src").substring(detailImage2.getAttribute("src").lastIndexOf("/") + 1);
		   	 	 String detailImg2 = "<p align=\"center\">"+"<img src='https://qudtn0295.cafe24.com/detailImage11/"+URLDecoder.decode(detailName2,"UTF-8").toString().substring(0, URLDecoder.decode(detailName2,"UTF-8").length()-4)+".jpeg"+"'/>"+"</p>";
            ...
            StringBuilder sb3 =new StringBuilder();
		   	for(WebElement detailImage3 : detailImageLists3) {
		   		 ...
		   		 System.out.println("3333333333333333333333"+imgUrl3);
		   		 ((JavascriptExecutor) driver).executeScript(
...
//		   		 Thread.sleep(3000);
	   			 detailName3 = detailImage3.getAttribute("src").substring(detailImage3.getAttribute("src").lastIndexOf("/") + 1);
		   	 	 String detailImg3 = "<p align=\"center\">"+"<img src='https://qudtn0295.cafe24.com/detailImage11/"+URLDecoder.decode(detailName3,"UTF-8").toString().substring(0, URLDecoder.decode(detailName3,"UTF-8").length()-4)+".jpeg"+"'/>"+"</p>";
        	...
        	WebElement title=driver.findElement(By.cssSelector("#contents > div.detaarea > div.bg_gray > div > div.xans-element-.xans-product.xans-product-detail > div.detailArea > div.infoArea > div.headingArea > h2"));
        	...
        	WebElement price=driver.findElement(By.cssSelector("#contents > div.detaarea > div.bg_gray > div > div.xans-element-.xans-product.xans-product-detail > div.detailArea > div.infoArea > div.pricearea > div.pricearea_a2 > li > div.disnoul_right > span > strong"));
        	List<WebElement> t = driver.findElements(By.id("add_option_0"));
        	if(t.size()>0) {
        		driver.findElement(By.id("add_option_0")).sendKeys("asd");
        	}
